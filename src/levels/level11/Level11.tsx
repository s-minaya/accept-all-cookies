 ...
 * escritura). Sin pie de ventana (corregido tras revisión de Sofía: "no me
 * convence que haya un botón de disagree") — toda la interacción, ganar y
 * perder, vive dentro del bocadillo (No/Yes), mismo patrón que los niveles
 * 8-9.
 */

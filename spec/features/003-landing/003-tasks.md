...
- [x] Montar `LandingScreen`: fondo a pantalla completa (con variante `landing-bg-mobile.png` por debajo de 1024px), Empezar centrado-abajo, `CornerMenu` con los cuatro accesos solo icono (estilo retro 8-bit — ver `003-plan.md`), estado de modal abierto.
...
- [x] QA responsive en los 5 anchos (recorte del fondo, legibilidad y disposición de la esquina) — verificado con Playwright (375/480/768/1280/1920px, sin errores de consola, botones ≥44px).

...
- [x] ✋ **Checkpoint con Sofía**: sprites/glifos de llave, candado y flechas aprobados ("los iconos de las flechas y las llaves lo damos por valido"). Layout móvil final aprobado ("ya esta perfecto"): el tablero es el protagonista (`--cell-size` a 27px en xs/sm, cerca del tamaño de escritorio), el panel de dirección de 3 filas se traslada al pie como una copia compacta 2×2 que ocupa el hueco del Agree deshabilitado mientras el candado sigue cerrado, y desaparece al abrirse.

...
7. **GDD** — retocar el bloque del Nivel 1: eliminar el diálogo propio de victoria ("Caso Agree") en favor del flujo estándar (edición manual del GDD, texto en tareas).
...
- **La receta de carpeta sale torcida y se copia once veces** — mitigación: revisión explícita de esta estructura antes de cerrar la feature (checkpoint en tareas); es más barato corregir el molde ahora.

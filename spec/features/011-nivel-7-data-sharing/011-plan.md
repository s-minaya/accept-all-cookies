...
- **Duplicar la pila para que "parezca" que hay dos botones verdes** (cubierta y Agree idénticos pueden leerse como un solo botón con sombra) — mitigación: es exactamente la ilusión que el GDD quiere; el checkpoint visual de Sofía confirma que el efecto "tarjeta que destapa otra" se lee bien al arrastrar.

...
- **La cubierta es un `XPButton` real (variante agree + texto disagree)** — cero estilos duplicados, y el "mismo tamaño y mismo color" del GDD sale gratis del sistema de diseño. Descartado: un div disfrazado (prohibido por la constitución).

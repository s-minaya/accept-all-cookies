...
- [x] La música suena claramente más baja que los efectos: multiplicador propio (~0.15 del volumen general) además del volumen de Ajustes. Confirmado por Sofía en el checkpoint: 0.15 está bien tal cual.

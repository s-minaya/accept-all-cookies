...
- [x] ✋ **Checkpoint con Sofía**: escuchar los tres audios en la playground y afinar el `musicVolumeFactor` (arranque: 0.15) y el volumen relativo de los efectos. — confirmado bien tal cual (0.15) el 2026-07-18; el 2026-07-20, tras oírlo ya desplegado en producción, Sofía lo bajó dos veces (0.5, luego 0.1) hasta quedar conforme → `MUSIC_VOLUME_FACTOR = 0.1`.
